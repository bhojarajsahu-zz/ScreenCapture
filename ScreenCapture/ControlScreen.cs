...
namespace ScreenCapture
{
	public partial class ControlScreen : Form
	{
		...
		public void SetScreenShot(bool value)
		{
		...
		{
			if (e.KeyCode.ToString() == "S" && (RectangleDrawn && (CursorPosition() == CursPos.WithinSelectionArea || CursorPosition() == CursPos.OutsideSelectionArea)) || e.KeyCode == Keys.ControlKey)
			{
				SaveSelection(true);
			}
		}
